...
class Test_update_image_bdm(OscTinaTest):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            cls.vm_info = oapi.create_Vms(cls.a1_r1, nb=1, bdm=bdm, state='stopped')
    ...
    def test_T0000_modified_type_to_std(self):
    ...
    def test_T0000_modified_type_to_io1(self):
    ...
    def test_T0000_modified_delete_on_termination(self):
    ...
    def test_T0000_modified_only_one_vol(self):
