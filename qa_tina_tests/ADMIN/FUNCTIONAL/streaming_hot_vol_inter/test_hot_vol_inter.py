...
class Test_hot_vol_inter(StreamingBaseHot):
    @classmethod
    def setup_class(cls):
        cls.w_size = 20
        cls.v_size = 10
        ...
        cls.check_data = True
        super(Test_hot_vol_inter, cls).setup_class()

    def test_T3135_hot_vol_inter(self):
    ...
    def test_T4218_hot_vol_inter_not_streamable(self):
