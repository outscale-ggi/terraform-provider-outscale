...
class Test_load_balancers(OscTinaTest):
    ...
    def test_T1574_private_internal_lbu(self):
        ...
        try:
            ...
            vpc_subnet = vpc_info[info_keys.SUBNETS][0]
            vpc_insts = vpc_subnet[info_keys.INSTANCE_SET]
    ...
    def test_T1575_private_internet_lbu(self):
        ...
        try:
            ...
            self.a1_r1.fcu.AuthorizeSecurityGroupIngress(GroupId=vpc_subnet[info_keys.SECURITY_GROUP_ID], IpProtocol='tcp',
                                                         FromPort=443, ToPort=443, CidrIp=Configuration.get('cidr', 'allips'))
            lb_sg = create_security_group(self.a1_r1, vpc_id=vpc_info[info_keys.VPC_ID])
    ...
    def test_T4657_lbu_with_udp(self):
        ...
        try:
            ...
            self.a1_r1.fcu.AuthorizeSecurityGroupIngress(GroupId=inst_info[info_keys.SECURITY_GROUP_ID], IpProtocol='tcp',
                                                         FromPort=80, ToPort=80, CidrIp=Configuration.get('cidr', 'allips'))
