...
from qa_tina_tools.tools.tina.create_tools import generate_new_key
...
class Test_CheckConnectionSsh(OscTestSuite):
    ...
    def test_TXXXX_valid_check_connection_import_ec_key_256(self):
        key_resp = None
        vm_info = None
        ...
        try:
            key_info = generate_new_key(keypair_name, key_size=ec.SECP256R1(), crypto_type=KeyType.ecdsa)
    ...
    def test_TXXXX_valid_check_connection_import_ec_key_384(self):
        key_resp = None
        vm_info = None
        ...
        try:
            key_info = generate_new_key(keypair_name, key_size=ec.SECP384R1(), crypto_type=KeyType.ecdsa)
    ...
    def test_TXXXX_valid_check_connection_import_ec_key_521(self):
        key_resp = None
        vm_info = None
        ...
        try:
            key_info = generate_new_key(keypair_name, key_size=ec.SECP521R1(), crypto_type=KeyType.ecdsa)
    ...
    def test_TXXXX_valid_check_connection_import_ed25519(self):
        key_resp = None
        vm_info = None
        ...
        try:
            key_info = generate_new_key(keypair_name, crypto_type=KeyType.ed25519)
    ...
    def test_TXXXX_valid_check_connection_rsa(self):
        key_resp = None
        vm_info = None
        ...
        try:
            key_info = generate_new_key(keypair_name, crypto_type=KeyType.rsa)
