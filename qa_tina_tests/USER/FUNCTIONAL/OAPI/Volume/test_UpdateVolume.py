...
from qa_tina_tools.tina import check_tools, info_keys
...
class Test_UpdateVolume(OscTestSuite):
    ...
    def setup_method(self, method):
        ...
        try:
            ...
            self.sshclient = check_tools.check_ssh_connection(self.a1_r1, self.inst_info[INSTANCE_ID_LIST][0], self.inst_info[INSTANCE_SET][0]['ipAddress'],
