...
class Test_tina_5734(OscTestSuite):
    ...
    def test_T5059_set_enable_and_reboot_instances(self):
        ...
        try:
            ...
            resp = self.a1_r1.intel.instance.find(id=vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0]).response
            ...
            inst = self.a1_r1.fcu.RunInstances(ImageId=self.a1_r1.config.region.get_info(cfg_constants.CENTOS7),
                                               ...
                                               MaxCount='1',
                                               MinCount='1',
                                               SecurityGroupId=vpc_info[info_keys.SUBNETS][0][info_keys.SECURITY_GROUP_ID],
                                               SubnetId=vpc_info[info_keys.SUBNETS][0][info_keys.SUBNET_ID],
                                               KeyName=vpc_info[info_keys.KEY_PAIR][info_keys.NAME],
            ...
            # check ssh
            sshclient_1 = check_tools.check_ssh_connection(self.a1_r1, vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0],
            ...
            sshclient_2 = check_tools.check_ssh_connection(self.a1_r1, inst.instancesSet[0].instanceId,
                                                           eip.response.publicIp, vpc_info[info_keys.KEY_PAIR][info_keys.PATH],
                                                           self.a1_r1.config.region.get_info(cfg_constants.CENTOS_USER))
            out, _, _ = SshTools.exec_command_paramiko(sshclient_2, 'pwd')

            # Stop inst 1
            self.a1_r1.fcu.StopInstances(InstanceId=vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0])
            wait_instances_state(osc_sdk=self.a1_r1, instance_id_list=[vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0]],
                                 state='stopped')
            ...
            # Start inst 1
            self.a1_r1.fcu.StartInstances(InstanceId=vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0])
            wait_instances_state(osc_sdk=self.a1_r1, instance_id_list=[vpc_info[info_keys.SUBNETS][0][info_keys.INSTANCE_ID_LIST][0]], state='ready')
