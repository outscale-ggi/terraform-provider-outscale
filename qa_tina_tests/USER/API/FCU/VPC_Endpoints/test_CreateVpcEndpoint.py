...
class Test_CreateVpcEndpoint(OscTestSuite):
    ...
    def test_T2608_with_same_route_table(self):
        ...
        try:
            ...
            msg = "VPC endpoint already exists for ServiceName: com.outscale.{}.osu, RouteTablesIDs: {}"
    ...
    def test_T4268_with_invalid_vpc_id(self):
        try:
            self.a1_r1.fcu.CreateVpcEndpoint(VpcId='net-toto', ServiceName='com.outscale.{}.osu'.format(self.a1_r1.config.region.name))
            assert False, 'Call should not have been successful'
        except OscApiException as err:
    ...
    def test_T4270_invalid_route_table_ids(self):
        try:
            self.a1_r1.fcu.CreateVpcEndpoint(VpcId=self.vpc_info[VPC_ID], ServiceName='com.outscale.{}.osu'.format(self.a1_r1.config.region.name),
                                             RouteTableId=['toto'])
            assert False, 'Call should not have been successful'
        except OscApiException as err:
