...
class Test_DescribeDhcpOptions(OscTestSuite):
    ...
    def test_T1508_no_param(self):
        ...
        validate_dhcp_options(ret=ret, dhcp_conf=self.dhcpconf, dhcp_item=self.dhcp_options_list[0])
        validate_dhcp_options(ret=ret, dhcp_conf=self.dhcpconf1, dhcp_item=self.dhcp_options_list[1])
        validate_dhcp_options(ret=ret, dhcp_conf=self.dhcpconf2, dhcp_item=self.dhcp_options_list[2])
