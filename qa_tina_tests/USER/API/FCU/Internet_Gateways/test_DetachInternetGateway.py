...
class Test_DetachInternetGateway(OscTestSuite):
    ...
    def test_T3924_missing_vpc_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id)
    ...
    def test_T3925_none_vpc_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id, VpcId=None)
            assert False, "Call should not be successful"
        except OscApiException as error:
            assert_error(error, 400, 'MissingParameter', "Parameter cannot be empty: VpcID")
        finally:
    ...
    def test_T3926_invalid_vpc_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id, VpcId="123456789012")
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3927_unknown_vpc_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id, VpcId="vpc-12345678")
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3929_incorrect_type_vpc_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id, VpcId=[self.vpc_info[VPC_ID]])
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3930_missing_igw_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(VpcId=self.vpc_info[VPC_ID])
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3931_none_igw_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId=None, VpcId=self.vpc_info[VPC_ID])
            assert False, "Call should not be successful"
        except OscApiException as error:
            assert_error(error, 400, 'MissingParameter', 'Parameter cannot be empty: GatewayID')
        finally:
    ...
    def test_T3933_invalid_igw_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId="123456789", VpcId=self.vpc_info[VPC_ID])
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3938_unknown_igw_id(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a1_r1.fcu.DetachInternetGateway(InternetGatewayId="igw-12345678", VpcId=self.vpc_info[VPC_ID])
            assert False, "Call should not be successful"
        except OscApiException as error:
    ...
    def test_T3943_from_another_account(self):
        ...
        self.att = self.a1_r1.fcu.AttachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
        try :
            resltDetach = self.a2_r1.fcu.DetachInternetGateway(InternetGatewayId=self.igw_id, VpcId=self.vpc_info[VPC_ID])
            assert False, "Call should not be successful"
        except OscApiException as error:
