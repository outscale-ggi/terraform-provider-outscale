...
class Test_CreateListenerRule(OscTinaTest):
    ...
    def check_error(self, code, list_desc=None, list_rule_desc=None, inst_ids=None):
        if not list_desc:
    ...
    def test_T4777_too_low_priority(self):
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 0, 'HostNamePattern': '*.com'})

    def test_T4778_too_high_priority(self):
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 20000, 'HostNamePattern': '*.com'})
    ...
    def test_T4780_incorrect_type_vms(self):
        self.check_error(4110, inst_ids=[self.inst_info[info_keys.INSTANCE_ID_LIST]])
    ...
    def test_T4783_incorrect_type_list_desc(self):
        self.check_error(4110, list_desc=[self.list_desc])

    def test_T4784_missing_ld_lbu_name(self):
        self.check_error(7000, list_desc={'LoadBalancerPort': 80})

    def test_T4785_missing_ld_lbu_port(self):
        self.check_error(7000, list_desc={'LoadBalancerName': self.lb_name})

    def test_T4786_incorrect_type_ld_lbu_name(self):
        self.check_error(4110, list_desc={'LoadBalancerName': 1234, 'LoadBalancerPort': 80})

    def test_T4787_incorrect_type_ld_lbu_port(self):
        self.check_error(4110, list_desc={'LoadBalancerName': self.lb_name, 'LoadBalancerPort': 'xxx'})
    ...
    def test_T4789_incorrect_type_list_rule_desc(self):
        self.check_error(4110, list_rule_desc=[{'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '*.com'}])

    def test_T4790_missing_lrd_priority(self):
        self.check_error(7000, list_rule_desc={'ListenerRuleName': self.rule_name, 'HostNamePattern': '*.com'})
    ...
    def test_T4793_incorrect_content_lrd_hostpattern(self):
        ...
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '$.com'})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '/.com'})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '\\.com'})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '".com'})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': "'.com"})
        ...
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': ":.com"})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': "+.com"})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': "*.abc.*.abc.*.abc.*.com"})
        self.check_error(4047, list_rule_desc={'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': "1234567890" * 13})
    ...
    def test_T4797_incorrect_content_lrd_ruleid(self):
        self.check_error(3001, list_rule_desc={'RuleId': 'xxx', 'ListenerRuleName': self.rule_name, 'Priority': 100, 'HostNamePattern': '*.com'})
    ...
    def test_T4798_incorrect_content_lrd_rulename(self):
        self.check_error(4110, list_rule_desc={'ListenerRuleName': 12345, 'Priority': 100, 'HostNamePattern': '*.com'})

    def test_T5441_missing_lrd_rulename(self):
        self.check_error(7000, list_rule_desc={'Priority': 100, 'HostNamePattern': '*.com'})
