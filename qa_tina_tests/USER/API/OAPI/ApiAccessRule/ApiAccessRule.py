...
class ApiAccessRule(OscTestSuite):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            cls.ca1files, cls.ca2files, cls.ca3files, cls.certfiles_ca1cn1, cls.certfiles_ca2cn1, cls.certfiles_ca1cn2, cls.certfiles_ca3cn1, cls.tmp_file_paths = create_certificate_setup()
