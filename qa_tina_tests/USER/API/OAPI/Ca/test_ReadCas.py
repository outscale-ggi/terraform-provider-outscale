...
class Test_ReadCas(OscTestSuite):
    ...
    def setup_class(cls):
        ...
        with open(cls.ca1files[1]) as f:
            cls.ca1 = cls.a1_r1.oapi.CreateCa(CaPem=f.read(), Description='test ca1')

        with open(cls.ca3files[1]) as f:
            cls.ca3 = cls.a1_r1.oapi.CreateCa(CaPem=f.read(), Description='test ca3')
