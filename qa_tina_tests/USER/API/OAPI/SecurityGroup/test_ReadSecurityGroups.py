...
#       "Tags": ["string"]
    ...
    def test_T2751_filters_account_ids(self):
        ...
        assert len(resp.SecurityGroups) == 4 + 2  # adding 2 default
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_account_ids.json'), self.hints)
    ...
    def test_T5481_filters_descriptions(self):
        ...
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_descriptions.json'), self.hints)
    ...
    def test_T5486_filters_inbound_rule_sg_ids(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 1
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_inbound_rule_sg_ids.json'), self.hints)

    def test_T5487_filters_inbound_sg_names(self):
        filters = {'InboundRuleSecurityGroupNames': [self.sg6.SecurityGroupName]}
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 1
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_inbound_rule_sg_names.json'), self.hints)
    ...
    def test_T5490_filters_outbound_rule_account_ids(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_outbound_rule_account_ids.json'), self.hints)
    ...
    def test_T5494_filters_outbound_sg_ids(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_outbound_rule_sg_ids.json'), self.hints)

    def test_T5495_filters_outbound_sg_names(self):
        filters = {'OutboundRuleSecurityGroupNames': [self.sg4.SecurityGroupName]}
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 1
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_outbound_rule_sg_names.json'), self.hints)
    ...
    def test_T5496_filters_outbound_to_port_ranges(self):
        ...
        verify_response(resp,
                        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_outbound_rule_to_port_ranges.json'),
                        self.hints)
    ...
    def test_T5497_filters_sg_ids(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        verify_response(resp,
                        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_sg_ids.json'),
                        self.hints)
    ...
    def test_T5498_filters_sg_names(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        verify_response(resp,
                        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_sg_names.json'),
                        self.hints)
    ...
    def test_T5369_filters_tags(self):
        ...
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 1
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_tags.json'), self.hints)

    def test_T5370_filters_tagkeys(self):
        filters = {"TagKeys": ['sg_key']}
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 2
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_tagkeys.json'), self.hints)

    def test_T5371_filters_tagvalues(self):
        filters = {"TagValues": ['sg_value']}
        resp = self.a1_r1.oapi.ReadSecurityGroups(Filters=filters).response
        assert len(resp.SecurityGroups) == 2
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_filters_tagvalues.json'), self.hints)
    ...
    def test_T3417_with_other_account(self):
        ...
        verify_response(resp, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'read_with_other_account.json'), self.hints)
