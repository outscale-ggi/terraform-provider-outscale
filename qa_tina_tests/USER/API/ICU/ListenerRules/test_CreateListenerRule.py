...
class Test_CreateListenerRule(OscTestSuite):
    ...
    def setup_class(cls):
        ...
        try:
            ...
            cls.list_rule_desc = {'RuleName': cls.rule_name, 'Priority': 100, 'HostPattern': '*.com'}
    ...
    def test_T1619_rule_limit_exceeded(self):
        ...
        try:
            ...
            ret_lr = self.a1_r1.icu.CreateListenerRule(ListenerDescription=self.list_desc,
                                                       ListenerRuleDescription=self.list_rule_desc,
    ...
    def check_error(self, status, code, msg, list_desc=None, list_rule_desc=None, inst_ids=None):
        ...
        ret_lr = None
        try:
            ret_lr = self.a1_r1.icu.CreateListenerRule(ListenerDescription=list_desc, ListenerRuleDescription=list_rule_desc, Instances=inst_ids)
            self.a1_r1.icu.DeleteListenerRule(RuleName=ret_lr.response.ListenerRule.ListenerRuleDescription.RuleName)
            ret_lr = None
    ...
    def test_T1765_too_low_priority(self):
        self.check_error(400, 'InvalidParameterValue',
                         ...
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 0, 'HostPattern': '*.com'})
    ...
    def test_T1766_too_high_priority(self):
        self.check_error(400, 'InvalidParameterValue',
                         ...
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 20000, 'HostPattern': '*.com'})

    def test_T1831_missing_instances(self):
        ret_lr = None
        try:
            ret_lr = self.a1_r1.icu.CreateListenerRule(ListenerDescription=self.list_desc, ListenerRuleDescription=self.list_rule_desc)
            assert False, 'Call should not have been successful'
        except OscApiException as error:
    ...
    def test_T1833_missing_list_desc(self):
        ret_lr = None
        try:
            ret_lr = self.a1_r1.icu.CreateListenerRule(ListenerRuleDescription=self.list_rule_desc, Instances=self.inst_id_list)
            assert False, 'Call should not have been successful'
        except OscApiException as error:
    ...
    def test_T1834_incorrect_type_list_desc(self):
        self.check_error(400, 'IcuClientException', "Invalid type, ListenerDescription must be a structure", list_desc=[self.list_desc])

    def test_T1835_missing_ld_lbu_name(self):
        self.check_error(400, 'IcuClientException', "Field ListenerDescription.LoadBalancerName is required", list_desc={'LoadBalancerPort': 80})

    def test_T1836_missing_ld_lbu_port(self):
        self.check_error(400, 'IcuClientException', "Field ListenerDescription.LoadBalancerPort is required",
                         list_desc={'LoadBalancerName': self.lb_name})
    ...
    def test_T1839_missing_list_rule_desc(self):
        ret_lr = None
        try:
            ret_lr = self.a1_r1.icu.CreateListenerRule(ListenerDescription=self.list_desc, Instances=self.inst_id_list)
            assert False, 'Call should not have been successful'
        except OscApiException as error:
    ...
    def test_T1840_incorrect_type_list_rule_desc(self):
        self.check_error(400, 'IcuClientException', "Invalid type, ListenerRuleDescription must be a structure",
                         list_rule_desc=[{'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '*.com'}])
    ...
    def test_T1841_missing_lrd_priority(self):
        self.check_error(400, 'IcuClientException', "Field ListenerRuleDescription.Priority is required",
                         list_rule_desc={'RuleName': self.rule_name, 'HostPattern': '*.com'})
    ...
    def test_T1842_incorrect_content_lrd_action(self):
        try:
            self.check_error(400, 'IcuClientException', "Field Instances is required",
                             list_rule_desc={'Action': 'xxx', 'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '*.com'})
    ...
    def test_T1843_incorrect_content_lrd_hostpattern(self):
        ...
        self.check_error(400, 'InvalidParameterValue', msg, list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '_.com'})
        self.check_error(400, 'InvalidParameterValue',
                         "Invalid value received for 'HostPattern': $.com. Supported patterns: ^[a-zA-Z0-9.*?-]{,128}$",
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '$.com'})
        self.check_error(400, 'InvalidParameterValue',
                         "Invalid value received for 'HostPattern': /.com. Supported patterns: ^[a-zA-Z0-9.*?-]{,128}$",
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '/.com'})
        ...
        self.check_error(400, 'InvalidParameterValue',
                         ...
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': "+.com"})
        self.check_error(400, 'InvalidParameterValue',
                         "Invalid value received for 'HostPattern': *.abc.*.abc.*.abc.*.com. Max wildcards supported: 3",
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': "*.abc.*.abc.*.abc.*.com"})
        self.check_error(400, 'InvalidParameterValue',
                         ("Invalid value received for 'HostPattern': "
                          "12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012"
                          "34567890123456789012345678901234567890. Supported patterns: ^[a-zA-Z0-9.*?-]{,128}$"),
                         list_rule_desc={'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': "1234567890" * 13})

    def test_T1844_valid_lrd_hostpattern(self):
        ret_lr = []
        try:
            ret_lr.append(self.a1_r1.icu.CreateListenerRule(ListenerDescription=self.list_desc,
                                                            ListenerRuleDescription={'RuleName': id_generator(prefix='rn-'),
    ...
    def test_T1847_incorrect_content_lrd_ruleid(self):
        self.check_error(400, 'IcuClientException', "Invalid type, ListenerRuleDescription.RuleId must be an integer",
                         list_rule_desc={'RuleId': 'xxx', 'RuleName': self.rule_name, 'Priority': 100, 'HostPattern': '*.com'})
    ...
    def test_T1848_incorrect_content_lrd_rulename(self):
        self.check_error(400, 'IcuClientException', "Invalid type, ListenerRuleDescription.RuleName must be a string",
                         list_rule_desc={'RuleName': 12345, 'Priority': 100, 'HostPattern': '*.com'})
    ...
    def test_T5344_forbid_wildcard(self):
        self.check_error(400, 'InvalidParameterValue', "Invalid Path Pattern received: \'*\' Single wildcard is not allowed",
                         list_rule_desc={'RuleName': id_generator(prefix='rn-'), 'Priority': 100, 'PathPattern': "*"})
