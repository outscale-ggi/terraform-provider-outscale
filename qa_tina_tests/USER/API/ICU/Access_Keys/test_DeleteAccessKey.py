...
class Test_DeleteAccessKey(OscTinaTest):
    ...
    def test_T345_without_param(self):
        ...
        try:
            ...
            misc.assert_error(error, 400, 'IcuClientException', 'Field AccessKeyId is required')
    ...
    def test_T346_with_param_but_empty(self):
        ...
        try:
            ...
            misc.assert_error(error, 400, 'MissingParameter', 'Parameter cannot be empty: AccessKeyId')
    ...
    def test_T347_invalid_accesskeyid_foo(self):
        ...
        try:
            ...
            misc.assert_error(error, 400, 'NoSuchEntity', None)
    ...
    def test_T349_invalid_accesskeyid_AK_partially_existant(self):
        ...
        try:
            ...
            if ret_create and ak and not ret_delete:
                sleep(30)
                self.a1_r1.icu.DeleteAccessKey(AccessKeyId=ak)
    ...
    def test_T5988_with_method_authLoginPassword_incorrect(self):
        sleep(30)
        ak = None
        ret_create = None
        ret_delete = None
        try:
            ret_create = self.a1_r1.icu.CreateAccessKey()
            ak = ret_create.response.accessKey.accessKeyId
            self.a1_r1.icu.DeleteAccessKey(exec_data={osc_api.EXEC_DATA_AUTHENTICATION: osc_api.AuthMethod.LoginPassword,
